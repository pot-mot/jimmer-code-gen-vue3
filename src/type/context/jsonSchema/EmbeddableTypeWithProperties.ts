...
const {
    ...
    ...entityOther
} = EmbeddableTypeJsonSchema.schema;
...
export const validateEmbeddableTypeWithProperties =
    createSchemaValidator<EmbeddableTypeWithProperties>(EmbeddableTypeWithProperties_JsonSchema);
