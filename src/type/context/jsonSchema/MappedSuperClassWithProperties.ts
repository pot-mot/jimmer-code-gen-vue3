...
import PropertyJsonSchema from '@/type/__generated/jsonSchema/items/MappedSuperClassProperty.ts';

const {
    definitions: mappedSuperClassDefinitions,
    properties: mappedSuperClassProperties,
    ...mappedSuperClassOther
} = MappedSuperClassJsonSchema.schema;
...
export const validateMappedSuperClassWithProperties =
    createSchemaValidator<MappedSuperClassWithProperties>(
        MappedSuperClassWithProperties_JsonSchema,
    );
