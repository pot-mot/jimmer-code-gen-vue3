...
import OneToOneAbstractAssociationIdOnly from '@/type/__generated/jsonSchema/items/OneToOneAbstractAssociationIdOnly.ts';
import ManyToOneAssociationIdOnly from '@/type/__generated/jsonSchema/items/ManyToOneAssociationIdOnly.ts';
import ManyToOneAbstractAssociationIdOnly from '@/type/__generated/jsonSchema/items/ManyToOneAbstractAssociationIdOnly.ts';
...
import ManyToManyAbstractAssociationIdOnly from '@/type/__generated/jsonSchema/items/ManyToManyAbstractAssociationIdOnly.ts';
...
export const validatePartialModelGraphSubData = createSchemaValidator(
    PartialModelGraphSubData_JsonSchema,
);
