...
export const isKeyProperty = (
    property: DeepReadonly<Property>,
): property is DeepReadonly<typeof property> & KeyProperty => {
    return 'key' in property && property.key;
};
export const isLogicalDeleteProperty = (
    property: DeepReadonly<Property>,
): property is DeepReadonly<typeof property> & LogicalDeleteProperty => {
    return 'logicalDelete' in property && property.logicalDelete;
};
export const isOrderableProperty = (
    property: DeepReadonly<Property>,
): property is DeepReadonly<typeof property> & {defaultOrderDirection: OrderDirection} => {
    return (
        'defaultOrderDirection' in property &&
        (property.defaultOrderDirection === 'ASC' || property.defaultOrderDirection === 'DESC')
    );
};

const toBaseProperty = (
    property: DeepReadonly<Property>,
...
const createColumnInfo = (
    ...
    return {
        name: nameTool.convert(
            'name' in property ? property.name : property.nameTemplate,
            'LOWER_CAMEL',
...
export const toIdProperty = (
    property: DeepReadonly<Property>,
): IdCommonProperty | IdEmbeddableProperty => {
...
export const exitIdProperty = (
    property: DeepReadonly<IdCommonProperty | IdEmbeddableProperty>,
): ScalarCommonProperty | ScalarEmbeddableProperty => {
...
export const toggleKeyProperty = (property: DeepReadonly<MayKeyProperty>) => {
...
type MayLogicalDeleteProperty = ScalarCommonProperty | ScalarEnumProperty;

export const isMayLogicalDeleteProperty = (
    property: Property,
): property is MayLogicalDeleteProperty => {
    return property.category === 'SCALAR_COMMON' || property.category === 'SCALAR_ENUM';
};
...
export const exitVersionProperty = (
    property: DeepReadonly<VersionProperty>,
): ScalarCommonProperty => {
    return {
        ...toBaseProperty(property),
        category: 'SCALAR_COMMON',
