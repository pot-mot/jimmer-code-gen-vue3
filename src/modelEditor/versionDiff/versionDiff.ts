...
export type ModelVersionDiff = DeepReadonly<{
    model:
        | ObjectDiff<Partial<Omit<Model, 'id' | 'createdTime' | 'modifiedTime'>>>
...
const nameIdAnyMatch = [
    (a: any, b: any): boolean => {
        if (
            ...
            'name' in a.data &&
            typeof a.data.name === 'string' &&
            'name' in b.data &&
            typeof b.data.name === 'string' &&
            'id' in a.data &&
            typeof a.data.id === 'string' &&
            'id' in b.data &&
            typeof b.data.id === 'string'
        )
    ...
    (a: any, b: any): boolean => {
        ...
        if ('id' in a && typeof a.id === 'string' && 'id' in b && typeof b.id === 'string')
            return a.id === b.id;
        return false;
    },
];
