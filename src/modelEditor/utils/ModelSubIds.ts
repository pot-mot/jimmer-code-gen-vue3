...
export const subDataToSubIds = (subData: Partial<DeepReadonly<ModelGraphSubData>>): ModelSubIds => {
    const result = defaultModelSubIds();
...
export const subIdSetToSubIds = (subIdSets: Partial<DeepReadonly<ModelSubIdSets>>): ModelSubIds => {
    const result = defaultModelSubIds();
...
export const subIdsToSubIdSets = (subIds: Partial<DeepReadonly<ModelSubIds>>): ModelSubIdSets => {
    const result = defaultModelSubIdSets();
