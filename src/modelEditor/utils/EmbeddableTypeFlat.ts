...
export const flatEmbeddableTypeColumns = (
    ...
    for (const property of overrideEmbeddableTypePropertiesColumnNames(
        embeddableType,
        embeddableTypeMap,
        columnNameOverrides,
    )) {
        if (property.category === 'SCALAR_COMMON' || property.category === 'SCALAR_ENUM') {
            ...
            columns.push(
                ...flatEmbeddableTypeColumns(property.embeddableTypeId, embeddableTypeMap),
            );
    }
...
export const flatEmbeddableTypeColumnNames = (
    ...
    for (const property of overrideEmbeddableTypePropertiesColumnNames(
        ...
        if (property.category === 'SCALAR_COMMON' || property.category === 'SCALAR_ENUM') {
            ...
            columnNames.push(
                ...flatEmbeddableTypeColumnNames(property.embeddableTypeId, embeddableTypeMap),
            );
    }
