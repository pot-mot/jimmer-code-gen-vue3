...
export type MappedPropertyInfo =
    | OneToOneMappedPropertyInfo
    | OneToManyMappedPropertyInfo
    | ManyToManyMappedPropertyInfo;
    ...
    for (const property of properties) {
        if (property.category === 'OneToOne_Source') {
            ...
            if (association.type !== 'OneToOne')
                throw new Error(`[${property.associationId}] is not OneToOne`);
            result.push({
                association,
            ...
            if (association.type !== 'ManyToOne')
                throw new Error(`[${property.associationId}] is not ManyToOne`);
            result.push({
                association,
                sourceProperty: property,
                mappedProperty: association.mappedProperty,
            ...
            if (association.type !== 'ManyToMany')
                throw new Error(`[${property.associationId}] is not ManyToMany`);
            result.push({
                association,
                sourceProperty: property,
                mappedProperty: association.mappedProperty,
...
export type AbstractMappedPropertyInfo =
    ...
    for (const property of properties) {
        if (property.category === 'OneToOne_Source') {
            ...
            if (association.type !== 'OneToOne_Abstract')
                throw new Error(`[${property.associationId}] is not OneToOne_Abstract`);
            result.push({
                association,
                sourceProperty: property,
                mappedProperty: association.mappedProperty,
            ...
            if (association.type !== 'ManyToOne_Abstract')
                throw new Error(`[${property.associationId}] is not ManyToOne_Abstract`);
            result.push({
                association,
                sourceProperty: property,
                mappedProperty: association.mappedProperty,
            ...
            const association = associationMap.get(property.associationId);
            if (!association) throw new Error(`[${property.associationId}] not found`);
            if (association.type !== 'ManyToMany_Abstract')
                throw new Error(`[${property.associationId}] is not ManyToMany_Abstract`);
            result.push({
                association,
                sourceProperty: property,
                mappedProperty: association.mappedProperty,
