...
export const getEntityLogicalDeleteProperties = (
    ...
    return getEntityExtendsProperty<
        (ScalarCommonProperty | ScalarEnumProperty) & LogicalDeleteProperty
    >(entity, mappedSuperClassMap, (property) => {
...
export const getEntityVersionProperties = (
    ...
    return getEntityExtendsProperty<VersionProperty>(entity, mappedSuperClassMap, (property) => {
