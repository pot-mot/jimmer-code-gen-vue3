...
import {
    ...
    getEntityLogicalDeleteProperties,
    getEntityVersionProperties,
...
export const mappedSuperClassDiagnose = (
    ...
    const logicDeletedProperties = getEntityLogicalDeleteProperties(
        mappedSuperClass,
    ...
    const versionProperties = getEntityVersionProperties(
        mappedSuperClass,
        contextData.mappedSuperClassMap,
    );
    ...
    const innerPropertyNameSet = new Set(
        mappedSuperClass.properties.map((property) => property.name),
    );
