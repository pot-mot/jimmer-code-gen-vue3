        ...
        sqlMatchRules: [
            {
                ...
                databaseSource: 'ANY',
                matchRegExp:
                    /^(text|(n)?(var)?char\(\d+\)|(tiny|small|medium|long)?text|character( varying)?\(\d+\))$/i.toString(),
            },
        ],
    },
    {
        ...
        jvmMatchRules: [
            {
                ...
                jvmSource: 'ANY',
                matchRegExp:
                    /^(int|Integer|Int|long|Long|short|Short|float|Float|double|Double)$/i.toString(),
            },
        ],
        sqlMatchRules: [
            {
                ...
                databaseSource: 'ANY',
                matchRegExp:
                    /^(int(eger)?|tinyint|bigint|smallint|real|float|double( precision)?)\(\d+\)\)?$/i.toString(),
            },
        ],
    },
    {
