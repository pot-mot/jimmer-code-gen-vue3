        ...
        <template #body>
            <div class="editor-item">
                ...
                <div>
                    <input
                        type="checkbox"
                        v-model="jvmTypeInput.serialized"
                    />
                </div>
            </div>
            <div class="editor-item">
                    ...
                    <template #line="{index}">
                        <div class="sub-line">
                            <div class="input-wrapper">
                                ...
                                />
                                <div
                                    v-if="errors[`extraImports.${index}`]"
                                    class="error-message"
                                >
                            ...
                            <button
                                class="delete-button"
                                @click="jvmTypeInput.extraImports.splice(index, 1)"
                            >
                                <IconDelete />
                            </button>
                        </div>
                    ...
                    <template #line="{index}">
                        <div class="sub-line">
                            <div class="input-wrapper">
                                ...
                                />
                                <div
                                    v-if="errors[`extraAnnotations.${index}`]"
                                    class="error-message"
                                >
                            ...
                            <button
                                class="delete-button"
                                @click="jvmTypeInput.extraAnnotations.splice(index, 1)"
                            >
                                <IconDelete />
                            </button>
                        </div>
                        ...
                        <template v-if="jvmTypeInput.sqlMatchRules[index]">
                            <div class="sub-line">
                                <DatabaseTypeOrAnySelect
                                    v-model="jvmTypeInput.sqlMatchRules[index].databaseSource"
                                />
                                <div class="input-wrapper">
                                    <input
                                ...
                                <button
                                    class="delete-button"
                                    @click="jvmTypeInput.sqlMatchRules.splice(index, 1)"
                                >
                                    <IconDelete />
                                </button>
                            </div>
                    ...
                    <template #line="{index}">
                        <template v-if="jvmTypeInput.tsMatchRules[index]">
                            <div class="sub-line">
                                ...
                                <button
                                    class="delete-button"
                                    @click="jvmTypeInput.tsMatchRules.splice(index, 1)"
                                >
                                    <IconDelete />
                                </button>
                            </div>
