<script setup lang="ts" generic="T extends TsTypeInput | TsTypeUpdateInput">
import type {TsTypeInput, TsTypeUpdateInput} from '@/api/__generated/model/static';
...
type TsImport = T['extraImports'][number];
type JvmMatchRule = T['jvmMatchRules'][number];
type SqlMatchRule = T['sqlMatchRules'][number];

const tsTypeInput = defineModel<T>({
    required: true,
});
...
const defaultJvmMatchRule = (): JvmMatchRule => {
    return {
        jvmSource: 'ANY',
        matchRegExp: '',
    };
...
const validateForm = (): boolean => {
    ...
    if (!tsTypeInput.value.typeExpression || tsTypeInput.value.typeExpression.trim() === '') {
        errors.value.typeExpression = translate({
        ...
        <template #head>
            <div class="ts-type-editor-header">
                <div class="input-wrapper">
                    ...
                    />
                    <div
                        v-if="errors.typeExpression"
                        class="error-message"
                    >
                        {{ errors.typeExpression }}
                    </div>
                    <div
                        class="error-message"
                        v-if="
        ...
        <template #body>
            <div class="editor-item">
                ...
                <EditList
                    ...
                    :to-key="(item: TsImport, index: number) => item.name + String(index)"
                        ...
                        <div class="sub-line">
                            <template v-if="tsTypeInput.extraImports[index]">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    />
                                    <div
                                        v-if="errors[`extraImports.${index}.name`]"
                                        class="error-message"
                                    >
                                ...
                                <div class="input-wrapper">
                                    ...
                                    />
                                    <div
                                        v-if="errors[`extraImports.${index}.fromPath`]"
                                        class="error-message"
                                    >
                            ...
                            <button
                                class="delete-button"
                                @click="tsTypeInput.extraImports.splice(index, 1)"
                            >
                                <IconDelete />
                            </button>
                        </div>
            ...
            <div class="editor-item">
                ...
                <EditList
                    ...
                    :to-key="(item: JvmMatchRule, index: number) => item.id ?? String(index)"
                        ...
                        <template v-if="tsTypeInput.jvmMatchRules[index]">
                            <div class="sub-line">
                                <JvmLanguageOrAnySelect
                                    v-model="tsTypeInput.jvmMatchRules[index].jvmSource"
                                />
                                <div class="input-wrapper">
                                    <input
                                ...
                                <button
                                    class="delete-button"
                                    @click="tsTypeInput.jvmMatchRules.splice(index, 1)"
                                >
                                    <IconDelete />
                                </button>
                            </div>
            ...
            <div class="editor-item">
                ...
                <EditList
                    ...
                    :to-key="(item: SqlMatchRule, index: number) => item.id ?? String(index)"
                        ...
                        <template v-if="tsTypeInput.sqlMatchRules[index]">
                            <div class="sub-line">
                                <DatabaseTypeOrAnySelect
                                    v-model="tsTypeInput.sqlMatchRules[index].databaseSource"
                                />
                                <div class="input-wrapper">
                                    <input
                                    ...
                                    />
                                    <div
                                        v-if="errors[`sqlMatchRules.${index}`]"
                                        class="error-message"
                                    >
                                ...
                                <button
                                    class="delete-button"
                                    @click="tsTypeInput.sqlMatchRules.splice(index, 1)"
                                >
                                    <IconDelete />
                                </button>
                            </div>
