...
<template>
    ...
    >
        ...
        <template #body>
            <div
                class="viewer-item"
                v-if="sqlType.dataSize !== undefined"
            >
            ...
            <div
                class="viewer-item"
                v-if="sqlType.numericPrecision !== undefined"
            >
            ...
            <div
                class="viewer-item"
                v-if="sqlType.defaultValue !== undefined"
            >
            ...
            <div
                class="viewer-item"
                v-if="sqlType.jvmMatchRules.length > 0"
            >
                <span class="label no-drag">{{ translate('jvmMatchRules') }}</span>
                <ul>
                    <li
                        v-for="item in sqlType.jvmMatchRules"
                        class="match-rule"
                    >
            ...
            <div
                class="viewer-item"
                v-if="sqlType.tsMatchRules.length > 0"
            >
                <span class="label no-drag">{{ translate('tsMatchRules') }}</span>
                <ul>
                    <li
                        v-for="item in sqlType.tsMatchRules"
                        class="match-rule"
                    >
                        <span class="no-drag">{{ item.matchRegExp }}</span>
                    </li>
