<script setup lang="ts" generic="T extends SqlTypeInput | SqlTypeUpdateInput">
import type {SqlTypeInput, SqlTypeUpdateInput} from '@/api/__generated/model/static';
...
const sqlTypeInput = defineModel<T>({
    required: true,
});
