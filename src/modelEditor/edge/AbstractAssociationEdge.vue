...
const sourceAbstractEntity = computed(() => {
    return contextData.mappedSuperClassMap.get(
        props.data.edgedAssociation.association.sourceAbstractEntityId,
    );
});
...
const associationNameCommentView = useIdViewNameComment(
...
const mappedPropertyNameCommentView = computed(() => {
    ...
    return {
        name: tmpl_mappedPropertyName(
            ...
            {
                name: sourceAbstractEntity.value
                    ? `$${sourceAbstractEntity.value.name}$`
                    : '[NOT_EXISTED]',
            },
        ...
        comment: tmpl_mappedPropertyComment(
            ...
            {
                comment: sourceAbstractEntity.value
                    ? `$${sourceAbstractEntity.value.comment}$`
                    : '[NOT_EXISTED]',
            },
                ...
                >
                    <div class="mapped-property-info">
                        ...
                        <MappedSuperClassViewer
                            :mapped-super-class="sourceAbstractEntity"
                            hide-comment
                            ctrl-focus
                        />
                        <span style="color: var(--comment-color)">$</span>
