...
const baseData: DeepReadonly<ModelContextData> = {
    ...
    associationMap: new Map<string, EdgedAssociation>([
        [
            ASSOCIATION_OneToOne.id,
            {association: ASSOCIATION_OneToOne, labelPosition: DEFAULT_LABEL_POSITION},
        ],
        [
            ASSOCIATION_OneToOne_midTable.id,
            {association: ASSOCIATION_OneToOne_midTable, labelPosition: DEFAULT_LABEL_POSITION},
        ],
        [
            ASSOCIATION_ManyToOne.id,
            {association: ASSOCIATION_ManyToOne, labelPosition: DEFAULT_LABEL_POSITION},
        ],
        [
            ASSOCIATION_ManyToOne_midTable.id,
            {association: ASSOCIATION_ManyToOne_midTable, labelPosition: DEFAULT_LABEL_POSITION},
        ],
        [
            ASSOCIATION_ManyToMany.id,
            {association: ASSOCIATION_ManyToMany, labelPosition: DEFAULT_LABEL_POSITION},
        ],
    ]),
