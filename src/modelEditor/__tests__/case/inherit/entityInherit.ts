    ...
    properties: [
        {
            ...
            serialized: false,
            extraImports: ['com.example.CustomPropertyAnnotationName'],
            extraAnnotations: ['@CustomPropertyAnnotationName(name = "name")'],
            key: true,
    ...
    properties: [
        {
            ...
            serialized: false,
            extraImports: ['com.example.CustomPropertyAnnotationName'],
            extraAnnotations: ['@CustomPropertyAnnotationName(name = "name11")'],
            category: 'SCALAR_COMMON',
            nullable: false,
            rawType: 'String',
            columnInfo: {
    ...
    properties: [
        {
            ...
            serialized: false,
            extraImports: ['com.example.CustomPropertyAnnotationName'],
            extraAnnotations: ['@CustomPropertyAnnotationName(name = "name12")'],
            category: 'SCALAR_COMMON',
            nullable: false,
            rawType: 'String',
            columnInfo: {
