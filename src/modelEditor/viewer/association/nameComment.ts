...
const getAbstractIdOnlyNameComment = (association: DeepReadonly<AbstractAssociationIdOnly>) => {
    ...
    if (
        ...
        (sourceProperty !== undefined &&
            'joinInfo' in sourceProperty &&
            sourceProperty.joinInfo.type === 'MidTable')
    ) {
...
export const useIdViewNameComment = (
    associationGetter: () => DeepReadonly<AssociationIdOnly> | undefined,
) => {
    return computed(() => {
