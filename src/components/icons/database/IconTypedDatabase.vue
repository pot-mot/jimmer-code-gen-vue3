<template>
    <IconMySql v-if="type === 'MYSQL'" />
    <IconPostgreSQL v-else-if="type === 'POSTGRESQL'" />
    <IconOracle v-else-if="type === 'ORACLE'" />
    <IconSqlServer v-else-if="type === 'SQLSERVER'" />
    <IconH2 v-else-if="type === 'H2'" />
    <IconSqlite v-else-if="type === 'SQLITE'" />
    <IconDatabase v-else />
</template>
