...
<template>
	<DragDialog :model-value="!!props.model" :init-w="1000" :init-y="50" :min-h="250" :init-h="editValue ? 600 : 360" can-resize @close="emits('cancel', props.model ? props.model : getDefaultModel())">
