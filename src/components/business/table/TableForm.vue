				...
				<template #columnType="{data, index}">
					<div style="padding: 0 0.5rem;">
						<el-tooltip :auto-close="500"
									:content="i18nStore.translate('LABEL_TableForm_columnType_pk')">
						...
						<el-tooltip v-if="data.partOfPk" :auto-close="500"
									:content="i18nStore.translate('LABEL_TableForm_columnType_autoIncrement')">
							<el-checkbox v-model="data.autoIncrement"
										 class="cling-checkbox"/>
						</el-tooltip>

						<el-tooltip v-if="!data.partOfPk" :auto-close="500"
									:content="i18nStore.translate('LABEL_TableForm_columnType_businessKey')">
						...
						<el-tooltip v-if="!data.partOfPk" :auto-close="500"
									:content="i18nStore.translate('LABEL_TableForm_columnType_logicalDelete')">
