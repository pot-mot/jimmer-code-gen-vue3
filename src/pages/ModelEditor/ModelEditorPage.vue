...
const {loadModel, contextData, loadTables} = useModelEditor();
...
const fetchModel = async () => {
    await withLoading('load model', async () => {
        ...
        try {
            ...
            sendMessage(translate({key: 'get_fail', args: [translate('model')]}), {
                type: 'warning',
            });
            console.error(e);
            await router.push({name: 'ModelList'});
...
onBeforeUnmount(() => {
    ...
    try {
        useGroupCreateDialog().close();
    } catch (e) {
        console.error(e);
    }
    try {
        useGroupEditDialog().close();
    } catch (e) {
        console.error(e);
    }
    try {
        usePropertyEditDialog().close();
    } catch (e) {
        console.error(e);
    }
    try {
        useModelContextMenu().close();
    } catch (e) {
        console.error(e);
    }
    try {
        useVersionDiffDialog().close();
    } catch (e) {
        console.error(e);
    }
});
