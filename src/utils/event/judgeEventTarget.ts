...
export const judgeElement = (el: Element | null, judge: (el: Element) => boolean | undefined) => {
...
export const judgeTarget = (e: UIEvent, judge: (el: Element) => boolean | undefined) => {
...
export const judgeTargetIsInteraction = (e: UIEvent) => {
